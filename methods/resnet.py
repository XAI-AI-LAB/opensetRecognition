...
class ResNet(nn.Module):
    def __init__(self, block = BasicBlock, num_block = [2,2,2,2],avg_output = False,output_dim = 256,preprocessstride = 1,resfirststride = 1,inchan = 3, args=None):
        super().__init__()
        self.args = args
        img_chan = inchan
        ...
        if output_dim > -1:
            ...
            # self.output_dim = (128+256+512) * block.expansion
